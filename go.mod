...
replace github.com/openshift/api => github.com/cdoern/api v0.0.0-20230929204029-1986a89124a3

replace github.com/openshift/client-go => github.com/cdoern/client-go v0.0.0-20230929204507-16e7bd6b8bb7

replace k8s.io/kube-openapi => github.com/openshift/kube-openapi v0.0.0-20220803164354-a70c9af30aea
